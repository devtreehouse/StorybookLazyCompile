...
function start(render) {
  ...
  var loadStories = function loadStories(loadable, framework) {
    return function () {
      ...
      var removed = _toConsumableArray(previousExports).filter(function (exp) {
      ...
      var added = _toConsumableArray(currentExports).filter(function (exp) {
  ...
  var configure = function configure(loadable, m, framework) {
    if (m && m.hot && m.hot.dispose) {
      ...
      previousExports = _ref10$previousExport === void 0 ? new Set() : _ref10$previousExport;
